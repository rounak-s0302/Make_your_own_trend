...
if __name__ == '__main__':
    ...
    main(args)
print(lis)
detailss="ucolor,upattern,ugender,useason,upper_ty,upper_sl,lcolor,lpattern,lgender,lseason,lower_ty,lower_sl,leg_pose\n"
# xyy=['color','pattern','gender','season','upper_ty','upper_sl','lower_ty','lower_sl','leg_pose']
# lis.append(xyy)
for i in lis:
  detailss=detailss+i+"\n"
print(detailss)
filex=open("details.csv","w")
filex.write(detailss)
filex.close()
